...
const PAGES = ["/ja", "/en", "/ja/works", "/ja/posts", "/ja/posts/hello-world", "/usogui-games"];

// axe computes color-contrast from raw foreground/background colors and doesn't
// account for `mix-blend-mode`. The strategy bars on /usogui-games intentionally
